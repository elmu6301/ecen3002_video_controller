...
# ACDS 20.1 720 win32 2021.02.14.11:09:50
# ----------------------------------------
...
# ----------------------------------------
# If refresh_pll is one of several IP cores in your
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "refresh_pll"
}
...
alias com {
  echo "\[exec\] com"
  eval  vlog -v2k5 $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/refresh_pll.vo"
}
